(function () {
    ...
    function runCheck() {
        ...
        const results = [];
        results.push(`【${ym.year}年${ym.month}月 出勤・退勤チェック結果】
勤怠管理のため、NG、超勤有、年次が正しいか確認してください。
出勤・退勤時間に修正が必要な場合は、備考及び修正欄に内容を入力してください。
ABC出勤は出勤時間を基に判定しています。
タイムカードの退社を押さないと最後にアクセスした時が退勤となるのでご注意ください。
OK判定
